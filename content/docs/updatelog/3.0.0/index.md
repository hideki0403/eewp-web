...
### アップデートに関するご注意
2020年 7月 1日より、Earthquake Early Warning Plus Bot （以下EEWP）をVer 3.0.0に更新いたします。  
...
Earthquake Early Warning Plusは2018年よりサービスを開始し、2021年にはおかげさまで650を超えるサーバーに導入して頂いています。  
...
#### 予想震度画像を最適化しました
{{< figure src="sample.png" width="100%" >}}
